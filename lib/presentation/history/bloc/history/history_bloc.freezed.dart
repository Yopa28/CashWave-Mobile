...
class _Success implements HistoryState {
  const _Success( List<OrderModel> histories): _histories = histories;
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is _Success&&const DeepCollectionEquality().equals(other.histories, _histories));
}


@override
int get hashCode {
    return Object.hash(runtimeType,const DeepCollectionEquality().hash(_histories));
}
